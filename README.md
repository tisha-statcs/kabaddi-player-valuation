...
This repository contains my response to **Problem 3: How Valuable Is a Player, Really?** 

The purpose of this project is to develop a quantitative model for measuring the value of a Kabaddi player at different times, acknowledging that a player generates value beyond on field statistics. The model will account for:
